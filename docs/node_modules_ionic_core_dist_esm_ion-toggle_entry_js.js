...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.disabled = false;
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_246ca78f_js__WEBPACK_IMPORTED_MODULE_9__.c.get('toggleOnOffLabels');
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_b49b173c_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  renderToggle() {
    ...
    }, this.inheritedAttributes)), (0,_index_b49b173c_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: {
...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new toggle syntax.`, this.el);
    ...
    }, this.renderToggleControl(), (0,_index_b49b173c_js__WEBPACK_IMPORTED_MODULE_1__.h)("label", {
      htmlFor: inputId
